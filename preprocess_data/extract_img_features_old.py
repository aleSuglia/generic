...
parser.add_argument("-feature_name", type=str, default="fc8", help="Pick the name of the network features default=(fc8 - block4)")
parser.add_argument("-out_dir", type=str, required=True, help="Output folder")
parser.add_argument("-dataset_name", type=str, default="guesswhat", help="Dataset files prefix")
parser.add_argument("-network", type=str, default="vgg", choices=["resnet", "vgg"], help="Use resnet/vgg network")
